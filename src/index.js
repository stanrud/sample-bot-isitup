...
bot.onConversationStarted(response => {
    say(response, `Hi there! I am ${bot.name}! Feel free to ask me if a web site is down for everyone or just you. Just send me a name of a website and I'll do the rest!`, {
        "Type":"keyboard",
        "DefaultHeight":true,
        "Buttons":[
           {
